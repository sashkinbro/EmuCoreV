...
//
// Installs firmware / VPK / PKG content by calling vanilla Vita3K public APIs.
// This file is the only place the install JNI symbols live; the upstream
// `vita3k` tree must stay untouched.
